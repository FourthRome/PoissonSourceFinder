...
namespace ConsoleTestApp
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //PointSource[] sources = new PointSource[] { new PointSource(0.5, Math.PI / 2 + 0.01, Math.PI / 4), new PointSource(0.5, 3 * Math.PI / 2 + 0.01, 3 * Math.PI / 4) };
            ...
            prediction.AzimuthalRanges.Add(new Tuple<double, double>(0.0, Math.PI / 2));
