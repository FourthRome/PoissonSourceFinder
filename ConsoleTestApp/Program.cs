...
namespace ConsoleTestApp
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            prediction.AzimuthalRanges.Add(new Tuple<double, double>(3 * Math.PI / 8, 3 *Math.PI / 8 + 0.02));
            prediction.PolarRanges.Add(new Tuple<double, double>(Math.PI/2, Math.PI/2 + 0.02));
